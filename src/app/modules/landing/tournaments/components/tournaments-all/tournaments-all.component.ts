...
export class TournamentsAllComponent implements OnInit {
    public activeTournament: any;
    public tournaments: any[] = [];
    public tournamentDetails: any;
    public openTournamentDetails = false;
    public openTournament = false;
    public openHelper = false;
    constructor() {}
    ...
    seeTournamentDetails(tournament: Tournament): void {
        if (this.activeTournament && this.activeTournament.id === tournament.id) {
          this.openTournamentDetails = false;
          this.activeTournament = null;
          return;
        }
        this.activeTournament = tournament;
        this.openTournamentDetails = true;
